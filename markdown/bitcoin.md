...
The incentive can also be funded with transaction fees. If the output value of a
...
The probability of an attacker catching up from a given deficit is analogous to
